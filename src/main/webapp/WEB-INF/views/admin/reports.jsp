...
<div class="container py-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-3"><div class="card text-center p-3"><div class="fs-4 fw-bold">$<%= String.format("%,.0f", reporte.ingresosTotales) %></div><div class="text-muted small">Ingresos Totales (Tiquetes)</div></div></div>
